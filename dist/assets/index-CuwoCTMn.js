...
function Js() {
  ...
  return ((be.Fragment = dl), (be.jsx = ll), (be.jsxs = ll), be)
}
var dm
function ws() {
  ...
  function b(v, E, O, r, C) {
        ...
        case 'object':
          switch (v.$$typeof) {
            ...
            case dl:
              ...
              break
            case F:
              return ((k = v._init), b(k(v._payload), E, O, r, C))
          }
      }
    if (k)
      return (
    ...
    if (Tt(v))
      for (var ol = 0; ol < v.length; ol++)
        ((r = v[ol]), (Q = Bl + Ut(r, ol)), (k += b(r, E, O, Q, C)))
    else if (((ol = wl(v)), typeof ol == 'function'))
      for (v = ol.call(v), ol = 0; !(r = v.next()).done; )
        ((r = r.value), (Q = Bl + Ut(r, ol++)), (k += b(r, E, O, Q, C)))
    else if (Q === 'object') {
      if (typeof v.then == 'function') return b(St(v), E, O, r, C)
      throw (
        (E = String(v)),
        Error(
  ...
  return (
    ...
    (B.cloneElement = function (v, E, O) {
      ...
      var r = ql({}, v.props),
        C = v.key
      if (E != null)
        for (Q in (E.key !== void 0 && (C = '' + E.key), E))
          !Xl.call(E, Q) ||
            Q === 'key' ||
            Q === '__self' ||
            Q === '__source' ||
      ...
      if (Q === 1) r.children = O
        ...
        for (var k = Array(Q), Bl = 0; Bl < Q; Bl++) k[Bl] = arguments[Bl + 2]
        r.children = k
      }
      return Et(v.type, C, r)
    }),
    ...
    (B.createElement = function (v, E, O) {
      ...
      if (k === 1) C.children = O
        ...
        for (var Bl = Array(k), ol = 0; ol < k; ol++) Bl[ol] = arguments[ol + 2]
        C.children = Bl
      }
      if (v && v.defaultProps)
        for (r in ((k = v.defaultProps), k)) C[r] === void 0 && (C[r] = k[r])
      return Et(v, Q, C)
    }),
...
function Ps() {
  ...
  var r = v(null),
    ...
    k = v(null)
  function Bl(l, t) {
    switch ((O(Q, t), O(C, l), O(r, null), t.nodeType)) {
      case 9:
      case 11:
  ...
  function Te(l) {
    ;(C.current === l && (E(r), E(C)),
      k.current === l && (E(k), (he._currentValue = q)))
  }
  var Qn, mi
  function Eu(l) {
    if (Qn === void 0)
...
` +
  ...
  var kl = Math.clz32 ? Math.clz32 : Rm,
    Nm = Math.log,
    pm = Math.LN2
  function Rm(l) {
  ...
  var jm = /[\n"\\]/g
  function ct(l) {
    return l.replace(jm, function (t) {
    ...
    Be = R({}, qa, {
      ...
      movementX: function (l) {
        return 'movementX' in l
          ...
          : (l !== Ba &&
              (Ba && l.type === 'mousemove'
                ? ((nf = l.screenX - Ba.screenX), (ff = l.screenY - Ba.screenY))
                : (ff = nf = 0),
              (Ba = l)),
            nf)
      },
  ...
  var a1 = R({}, qa, {
    ...
    c1 = Zl(f1),
    i1 = R({}, Ou, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    y1 = Zl(i1),
    v1 = R({}, Be, {
      deltaX: function (l) {
        return 'deltaX' in l
  ...
  function Ii(l) {
    if (l.propertyName === 'value' && Ce(Ga)) {
      var t = []
      ;(wi(t, Ga, l, tf(l)), Ci(z1, t))
    }
  }
  function T1(l, t, u) {
    l === 'focusin'
      ? (ki(), (Ya = t), (Ga = u), Ya.attachEvent('onpropertychange', Ii))
      : l === 'focusout' && ki()
  }
  function E1(l) {
  ...
  function Xa(l, t) {
    ...
    for (a = 0; a < u.length; a++) {
      var e = u[a]
      if (!xn.call(t, e) || !Il(l[e], t[e])) return !1
    }
    return !0
  }
  function Pi(l) {
  ...
  var n0 = ru('animationend'),
    f0 = ru('animationiteration'),
    c0 = ru('animationstart'),
    r1 = ru('transitionrun'),
    D1 = ru('transitionstart'),
    U1 = ru('transitioncancel'),
    i0 = ru('transitionend'),
    y0 = new Map(),
    gf =
  ...
  function Of(l) {
    for (; l === Ze; )
      ((Ze = ta[--ua]), (ta[ua] = null), (ja = ta[--ua]), (ta[ua] = null))
    for (; l === kt; )
      ((kt = vt[--mt]),
        (vt[mt] = null),
        (Ot = vt[--mt]),
  ...
  var N1 =
    ...
    p1 = U.unstable_scheduleCallback,
    R1 = U.unstable_NormalPriority,
    bl = {
      $$typeof: Nl,
      Consumer: null,
      Provider: null,
  ...
  function r0(l) {
    ...
    function M(m, y, s, z) {
      for (
        var H = null, J = null, D = y, G = (y = 0), V = null;
        D !== null && G < s.length;
        G++
      ) {
    ...
    function p(m, y, s, z) {
      ...
      for (
        var H = null, J = null, D = y, G = (y = 0), V = null, w = s.next();
        D !== null && !w.done;
        G++, w = s.next()
      ) {
        D.index > G ? ((V = D), (D = null)) : (V = D.sibling)
  ...
  var ya = v(null),
    $e = v(0)
  function N0(l, t) {
    ;((l = Lt), O($e, l), O(ya, t), (Lt = l | t.baseLanes))
  }
  function Xf() {
    ;(O($e, Lt), O(ya, ya.current))
  }
  function Qf() {
    ;((Lt = $e.current), E(ya), E($e))
  }
  var lt = v(null),
    dt = null
  function eu(l) {
  ...
  function R0(l) {
    ...
    if (((Yt = 0), (zl = ul = Y = null), (ke = !1), ($a = 0), (ma = null), t))
      throw Error(o(300))
  ...
  function Kf(l) {
    ...
    ;((Yt = 0), (zl = ul = Y = null), (va = !1), ($a = Ie = 0), (ma = null))
  }
  function Cl() {
    var l = {
      memoizedState: null,
  ...
  function B0(l, t, u) {
    ...
    if (
      ...
      if (
        ((a.flags |= 2048),
        sa(9, { destroy: void 0 }, Y0.bind(null, a, e, u, t), null),
        fl === null)
      )
        throw Error(o(349))
      n || (Yt & 127) !== 0 || C0(a, t, u)
  ...
  function Pf(l, t, u) {
    return u === void 0 || ((Yt & 1073741824) !== 0 && (x & 261930) === 0)
      ? (l.memoizedState = t)
      : ((l.memoizedState = u), (l = nv()), (Y.lanes |= l), (iu |= l), u)
  }
  function ny(l, t, u, a) {
    return Il(u, t)
      ? u
  ...
  var hy = {
      ...
      useSyncExternalStore: function (l, t, u) {
        ...
        return (
          ...
          (a.flags |= 2048),
          sa(9, { destroy: void 0 }, Y0.bind(null, a, n, u, t), null),
          u
        )
      },
      useId: function () {
      ...
      useCacheRefresh: function () {
        return (Cl().memoizedState = Z1.bind(null, Y))
      },
      ...
      return (
        ...
        t !== null
          ? ((t.flags & 65536) === 0 && (t.flags |= 256),
            (t.flags |= 65536),
            (t.lanes = e),
            a !== Mf && ((l = Error(o(422), { cause: a })), Za(yt(l, u))))
          : (a !== Mf && ((t = Error(o(423), { cause: a })), Za(yt(t, u))),
  ...
  function Yy(l, t, u) {
    if (l !== null)
      if (l.memoizedProps !== t.pendingProps) Tl = !0
        ...
        if (!oc(l, u) && (t.flags & 128) === 0) return ((Tl = !1), K1(l, t, u))
        Tl = (l.flags & 131072) !== 0
      }
    else ((Tl = !1), K && (t.flags & 1048576) !== 0 && h0(t, ja, t.index))
    switch (((t.lanes = 0), t.tag)) {
      case 16:
        l: {
          ...
          if (((l = qu(t.elementType)), (t.type = l), typeof l == 'function'))
            Tf(l)
              ? ((a = Gu(l, a)), (t.tag = 1), (t = py(null, t, l, a, u)))
      ...
      case 1:
        return ((a = t.type), (e = Gu(a, t.pendingProps)), py(l, t, a, e, u))
      case 3:
        l: {
          ...
          if (
            ...
            if (
              ...
              ;((e = yt(Error(o(424)), t)), Za(e), (t = Ry(l, t, a, u)))
              break l
            } else {
      ...
      case 5:
        return (
          l === null &&
            K &&
            ((e = a = cl) &&
              ((a = Es(a, t.type, t.pendingProps, st)),
              a !== null
                ? ((t.stateNode = a),
                  (rl = t),
                  (cl = ht(a.firstChild)),
          ...
          t.memoizedState !== null &&
            ((e = xf(l, t, Y1, null, null, u)), (he._currentValue = e)),
          cn(l, t),
          Ul(l, t, a, u),
          t.child
        )
    ...
    switch ((Of(t), t.tag)) {
      ...
      case 27:
        if (
          ...
          ;((l = r.current),
            aa(t) ? S0(t) : ((l = Lv(e, a, u)), (t.stateNode = l), Qt(t)))
        }
        return (il(t), null)
      case 5:
      ...
      case 13:
        ;(xt(l, u),
          ...
          a & 64 &&
            ...
            l !== null &&
              ((l = l.dehydrated),
              l !== null && ((u = as.bind(null, u)), _s(l, u)))))
        break
      case 22:
  ...
  function Vt(l, t, u) {
    for (u = u && (t.subtreeFlags & 8772) !== 0, t = t.child; t !== null; ) {
      ...
      switch (n.tag) {
        ...
        case 26:
        case 5:
          ;(Vt(e, n, u), u && a === null && f & 4 && Zy(n), ue(n, n.return))
          break
        case 12:
          Vt(e, n, u)
          break
  ...
  function Py(l, t, u) {
    switch (l.tag) {
      ...
      case 4:
        var a = bt
        ;((bt = rn(l.stateNode.containerInfo)), ha(l, t, u), (bt = a))
        break
      case 22:
        l.memoizedState === null &&
          ((a = l.alternate),
  ...
  var F1 = {
    ...
    Uc = null
  function et() {
    return ($ & 2) !== 0 && x !== 0 ? x & -x : b.T !== null ? Bc() : Ti()
  }
  function nv() {
    if (at === 0)
      if ((x & 536870912) === 0 || K) {
  ...
  function Jl(l, t, u) {
    ;(((l === fl && (I === 2 || I === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ua(l, u),
      (($ & 2) === 0 || l !== fl) &&
        (l === fl && (($ & 2) === 0 && (Qu |= u), sl === 4 && mu(l, x, at, !1)),
        rt(l)))
  }
  function fv(l, t, u) {
    ...
    do {
      if (e === 0) {
        ...
        l: {
          ...
          cv(a, u, Kl, Sn, Mc, t, at, Qu, Sa, cu, n, null, -0, 0)
        }
      }
      break
    } while (!0)
  ...
  function Hc() {
    if (j !== null) {
      ...
      else ((l = j), (Bt = Nu = null), Kf(l), (ia = null), (La = 0), (l = j))
  ...
  function bn() {
    ;((sl = 4),
      cu || ((x & 4194048) !== x && lt.current !== null) || (oa = !0),
  ...
  function dv(l) {
    ...
    switch (t.tag) {
      case 15:
      case 0:
        t = Ny(u, t, t.pendingProps, t.type, void 0, x)
        break
      case 11:
        t = Ny(u, t, t.pendingProps, t.type.render, t.ref, x)
        break
      case 5:
        Kf(t)
      default:
        ;(Xy(u, t), (t = j = m0(t, Lt)), (t = Yy(u, t, Lt)))
    }
    ;((l.memoizedProps = l.pendingProps), t === null ? zn(l) : (j = t))
  }
  function za(l, t, u, a) {
  ...
  function bv() {
    if (Al === 4 || Al === 3) {
      ...
      ;(t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
        ? (Al = 5)
        : ((Al = 0), (ga = vu = null), zv(l, l.pendingLanes))
  ...
  function pc(l, t, u) {
    ...
    e.has(u) ||
      ((_c = !0), e.add(u), (l = us.bind(null, l, t, u)), t.then(l, l))
  }
  function us(l, t, u) {
    var a = l.pingCache
    ;(a !== null && a.delete(t),
      ...
      fl === l &&
        (x & u) === u &&
        (sl === 4 || (sl === 3 && (x & 62914560) === x && 300 > $l() - hn)
          ? ($ & 2) === 0 && ba(l, 0)
          : (Oc |= u),
        Sa === x && (Sa = 0)),
      rt(l))
  ...
  function Av(l, t) {
    ;(t === 0 && (t = Si()), (l = Du(l, t)), l !== null && (Ua(l, t), rt(l)))
  }
  function as(l) {
    var t = l.memoizedState,
      u = 0
  ...
  for (var Cc = 0; Cc < gf.length; Cc++) {
    var Yc = gf[Cc],
      ys = Yc.toLowerCase(),
      vs = Yc[0].toUpperCase() + Yc.slice(1)
    gt(ys, 'on' + vs)
  }
  ;(gt(n0, 'onAnimationEnd'),
    ...
    gt('focusin', 'onFocus'),
    gt('focusout', 'onBlur'),
    gt(r1, 'onTransitionRun'),
    gt(D1, 'onTransitionStart'),
    gt(U1, 'onTransitionCancel'),
          ...
          for (var y = d, s; y !== null; ) {
            ...
            if (
              ...
              (z !== 5 && z !== 26 && z !== 27) ||
                s === null ||
                m === null ||
                ((z = pa(y, m)), z != null && p.push(ve(y, z, s))),
              el)
            )
              break
            y = y.return
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              t: {
                for (p = ss, m = S, y = M, s = 0, z = m; z; z = p(z)) s++
                z = 0
...
`,
  ...
  var Jt = _.d
  _.d = { f: Os, r: Ms, D: rs, C: Ds, L: Us, m: Hs, X: ps, S: Ns, M: Rs }
  function Os() {
    var l = Jt.f(),
      t = gn()
    return l || t
  ...
  function Cn(l, t) {
    l.blockedOn === t &&
      ((l.blockedOn = null),
      ui ||
        ((ui = !0), U.unstable_scheduleCallback(U.unstable_NormalPriority, Vs)))
  }
  var Yn = null
  function ym(l) {
    Yn !== l &&
...
function ld() {
  ...
  return (U(), (ni.exports = Ps()), ni.exports)
}
var td = ld()
const vi = U =>
    zu.jsx('button', {
      className:
        'cursor-pointer rounded-lg border-b-4 border-blue-800 bg-blue-600 px-6 py-2 font-bold text-white shadow-lg transition-all hover:border-blue-900 hover:bg-blue-700 active:scale-95',
      children: U.texto,
    }),
  ud = () =>
    zu.jsxs('div', {
      className:
        'flex h-screen flex-col items-center justify-center gap-4 bg-zinc-900',
      children: [
        zu.jsx('h1', {
          className: 'text-3xl font-bold text-white',
          children: 'Minha Base (Home)',
        }),
        zu.jsx(vi, { texto: 'Atacar' }),
        zu.jsx(vi, { texto: 'Defender' }),
        zu.jsx(vi, { texto: 'Fugir' }),
      ],
    }),
  ad = () => zu.jsx(ud, {})
td.createRoot(document.getElementById('root')).render(zu.jsx(ad, {}))
